...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println(String.format(Locale.getDefault(), "name: %s, length: %s(0x%X), md5: %s",
                name, getLengthDesc(length), length, md5));
...
//                                            System.out.println("n = " + n);
    ...
    static void sendFileInfo(OutputStream outputStream) throws IOException {
        ...
        System.out.println("send md5 begin");
        buffer = md5.getBytes();
        outputStream.write(buffer.length);
        outputStream.write(buffer);
        System.out.println("send md5 end");
    }
}
